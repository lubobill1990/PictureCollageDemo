...
void Test::Step(Settings* settings)
{
	...
	//告诉render文件中的DebugDraw要画哪些东西，这个DebugDraw继承b2DebugDraw（b2WorldCallbacks）
	uint flags = 0;
	...
	m_debugDraw.SetFlags(flags);	//没找到这个flag是做什么用的，觉得应该由flag数值决定是否画某些部件
...
#include <iostream>
using namespace std;
void Test::Keyboard( unsigned char key )
{
	B2_NOT_USED(key); 
}
